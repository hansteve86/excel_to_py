...
#imports .csv file with windtunnel data
df = pd.read_csv('lab1file2.csv')

#port 1-10 are recorded on the wing, 11-20 are atmospheric pressure
cols1 = ['P 1','P 2','P 3','P 4','P 5'
        ,'P 6','P 7','P 8','P 9','P 10']
cols2 = ['P 11','P 12','P 13','P 14','P 15'
        ,'P 16','P 17','P 18','P 19','P 20']

#extract datas recorded in wing ports and take average, then assign to new list
p_ave_lst_mbar = []
for items in cols1:
...
#extract datas recorded in atmospheric ports then assign to new list
ptotal_ave_lst_mbar = []
for item in cols2:
...
#find mean of atmospheric ports
...
#convert pressure units from mbar to pascal
q_processed = []
...
#velocity calculation from dynamic pressure
rho = 1.19
v = []
